        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-4">
            ...
            {getTopAndBottomPueblos().top.length > 0 ? (
              getTopAndBottomPueblos().top.map((pueblo) => (
                <div key={pueblo.name} className="flex items-center justify-between bg-green-50 p-3 rounded-lg">
          ...
          <div className="space-y-4">
            ...
            {getTopAndBottomPueblos().bottom.map((pueblo) => (
              <div key={pueblo.name} className="flex items-center justify-between bg-red-50 p-3 rounded-lg">
                <span className="font-medium">{pueblo.name}</span>
                <div className="flex items-center">
